...
export const heroBand = ({ kicker, title, subtitle, primaryHref, primaryText, secondaryHref, secondaryText, bgGenId }) => `
  <section class="relative overflow-hidden">
      ...
      <div class="grid gap-10 lg:grid-cols-12 items-center">
        <div class="lg:col-span-7">
          <div class="inline-flex items-center gap-2 rounded-full bg-white/80 subtle-border px-3 py-1.5 text-xs font-extrabold text-slate-700">
            <span class="h-2 w-2 rounded-full bg-gradient-to-r from-orange-500 to-orange-600"></span>
            ${kicker}
          </div>
          ...
          <div class="mt-7 flex flex-col sm:flex-row gap-3">
            <a href="${primaryHref}" class="inline-flex items-center justify-center rounded-2xl bg-[#00a99d] px-6 py-4 text-sm sm:text-base font-extrabold text-white hover:opacity-95 hover:-translate-y-0.5 transition transform">
    ...
    { icon: "bi-graph-up-arrow", title: "Conversion-focused", desc: "Clear hierarchy that builds trust quickly." }
              ...
              <div class="mt-5 rounded-2xl bg-gradient-to-r from-teal-50 to-teal-100 border border-slate-200/60 p-4">
