...
export const ctaBand = ({ title, subtitle, primaryHref, primaryText, secondaryHref, secondaryText, bg = "from-teal-50 to-blue-50" }) => `
    ...
    <div class="rounded-3xl border border-slate-200/70 bg-gradient-to-r ${bg} p-7 sm:p-10 overflow-hidden relative">
      ...
      <div class="relative grid gap-8 lg:grid-cols-12 items-center">
        ...
        <div class="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 lg:justify-end">
          <a href="${primaryHref}" class="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-emerald-500 to-orange-500 px-6 py-4 text-sm font-extrabold text-white hover:opacity-95 hover:-translate-y-0.5 transition transform">
